...
const workerConfig = {
  ...
  monitors: [
    ...
    // 示例HTTP监控
    {
      ...
      method: 'GET',
      // target是有效的URL
      target: 'https://qmws.fsan-cloud.com:8488/',
      // [可选] tooltip只用于状态页面显示工具提示
      tooltip: '犬民卫士-城市犬只智能管理服务平台',
      // [可选] statusPageLink只用于状态页面上的可点击链接
      statusPageLink: 'https://qmws.fsan-cloud.com:8488/',
      // [可选] expectedCodes是一个可接受的HTTP响应码数组，如果未指定，默认为2xx
      expectedCodes: [200],
      // [可选] 如果指定，响应必须包含该关键词才能被视为正常。
      // responseKeyword: '',
    ...
    // 示例TCP监控
    {
      ...
      method: 'TCP_PING',
      // target对于tcp监控应该为主机:端口
      target: '36.134.229.65:22',
      tooltip: '犬民卫士服务器可用性监控',
      // [可选] 如果指定，检查将在你指定的区域运行，
      // 在设置此值之前，请参考文档 https://github.com/lyc8503/UptimeFlare/wiki/Geo-specific-checks-setup
      checkLocationWorkerRoute: 'https://twget.okr.pub/'
    },
    ...
    {
      id: 'udpn-hkg3',
      name: '中港专线香港段Server-hkg3',
      // method对于tcp监控应该为TCP_PING
      method: 'TCP_PING',
      // target对于tcp监控应该为主机:端口
      target: '46.151.32.161:2053',
      tooltip: '中港专线香港段可用性监控',
      // [可选] 如果指定，检查将在你指定的区域运行，
      // 在设置此值之前，请参考文档 https://github.com/lyc8503/UptimeFlare/wiki/Geo-specific-checks-setup
      checkLocationWorkerRoute: 'https://twget.okr.pub/'
